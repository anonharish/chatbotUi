...
export default function DashboardPage() {
  return (
    <div className="min-h-screen pl-20 pr-12 pt-6 pb-12">
      {/* ===== TOP ROW ===== */}
      ...
      <div className="grid grid-cols-3 gap-8 mt-8">
        ...
        <GlassCard className="col-span-2 h-[370px]">
          ...
          <ResponsiveContainer width="95%" height="90%">
            <BarChart data={compareData} barGap={12} barCategoryGap="30%">
              <CartesianGrid
                stroke="white"
                strokeOpacity={0.18}
                strokeDasharray="2 8"
              ...
              <Bar dataKey="a" shape={<OutlineCapsuleBar />} barSize={40} />
