    ...
    <div className="profile-header">
      ...
      <div className="profile-info">
        ...
        <div className="profile-left">
          ...
          >
            <img src={preview} className="profile-pic object-cover" alt="Profile" />
            ...
            <div className="profile-edit-overlay absolute inset-0 flex items-center justify-center bg-black/40 rounded-full opacity-0 group-hover:opacity-100 transition">
              <img src="/src/assets/icons/edit.png" className="w-6 h-6" alt="Edit" />
            </div>
          </div>

          <input type="file" accept="image/*" ref={fileInputRef} hidden onChange={handlePhotoChange} />

          {/* TEXT */}
          <div className="profile-text">
            <h2>{name}</h2>
            <p>{roleLabel}</p> {/* ✅ dynamic instead of hardcoded "Agent" */}
          </div>
