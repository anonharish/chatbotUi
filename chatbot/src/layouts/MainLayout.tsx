...
export default function MainLayout() {
  ...
  return (
    <div className="min-h-screen text-foreground relative">
      ...
      <div className="fixed inset-0 -z-10 bg-[url('/background.jpg')] bg-cover bg-center bg-no-repeat before:absolute before:inset-0 before:bg-black/30 before:content-['']" />
