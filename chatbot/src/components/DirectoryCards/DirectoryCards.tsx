...
export default function DirectoryCards() {
  ...
  const calculate = useCallback(() => {
    ...
    if (
      ...
      agentsRefs.current[selectedOfficer]
    ) {
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  />
                  <line
                    x1={coords.rRight} y1={centerY}
                    x2={spineX}        y2={centerY}
